            ...
            <div className={`absolute inset-0 rounded-3xl transition-all duration-500 overflow-hidden ${isHovered ? 'bg-indigo-600/10 scale-[1.02] shadow-[0_0_40px_rgba(99,102,241,0.2)]' : 'bg-white/5'
                ...
                <div className="relative z-10 p-6 md:p-10 h-full flex flex-col items-center justify-center text-center">
                    ...
                    <ScrollReveal delay={400}>
                        <div className={`mt-6 md:mt-8 transition-all duration-700 ${isHovered ? 'opacity-100 translate-y-0' : 'opacity-100 md:opacity-0 translate-y-0 md:translate-y-4'}`}>
                            <span className="px-4 py-1.5 md:px-6 md:py-2 rounded-full bg-indigo-500/20 border border-indigo-500/40 text-indigo-400 text-xs md:text-sm font-bold tracking-wider uppercase">
                                Explore Tech
                            </span>
                        </div>
                    </ScrollReveal>
