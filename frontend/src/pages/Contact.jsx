...
export default function Contact({ onNavigate }) {
  ...
  return (
    <div className="page-container min-h-[100svh]">
      {/* Hero Section */}
      ...
      <section className="min-h-[100svh] flex items-center justify-center px-4 sm:px-8 pb-20 md:pb-0 relative overflow-hidden">
